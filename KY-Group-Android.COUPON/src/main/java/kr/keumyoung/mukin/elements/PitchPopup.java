...
public class PitchPopup extends ControlsPopup implements BubbleSeekBar.OnProgressChangedListener {
    ...
    protected View getContainerView(FrameLayout parent) {
        View view = LayoutInflater.from(activity).inflate(R.layout.pitch_popup, parent, false);
