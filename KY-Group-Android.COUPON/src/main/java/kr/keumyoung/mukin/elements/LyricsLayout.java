...
//		System.out.println("object.getWords().size() " + object.getWords().size() + " currentIndex " + currentIndex);
        ...
        //        lyricView = new LyricView(getContext(), object, object.getCurrentWord(), LyricView.State.CURRENT);
				lyricView = new LyricView(getContext(), object, object.getWords().get(index), LyricView.State.CURRENT);
            else
