...
typedef enum {
	...
	BSSE_CTRL_LOAD_INSTRUMENT = 10030, /* <customized version only> */
	BSSE_CTRL_UNLOAD_ALL_INSTRUMENT, /* <customized version only> */
	...
	BSSE_CTRL_SET_AUDIO_INPUT = 13000, /* <customized version only> */
	BSSE_CTRL_GET_AUDIO_INPUT, /* <customized version only> */
	BSSE_CTRL_SET_AUDIO_INPUT_VOLUME, /* <customized version only> */
	BSSE_CTRL_GET_AUDIO_INPUT_VOLUME, /* <customized version only> */
	BSSE_CTRL_SET_AUDIO_INPUT_REVERB_SEND_LEVEL, /* <customized version only> */
	BSSE_CTRL_GET_AUDIO_INPUT_REVERB_SEND_LEVEL, /* <customized version only> */
	BSSE_CTRL_SET_AUDIO_INPUT_CHORUS_SEND_LEVEL, /* <customized version only> */
	BSSE_CTRL_GET_AUDIO_INPUT_CHORUS_SEND_LEVEL, /* <customized version only> */
	BSSE_CTRL_SET_AUDIO_INPUT_DELAY_SEND_LEVEL, /* <customized version only> */
	BSSE_CTRL_GET_AUDIO_INPUT_DELAY_SEND_LEVEL, /* <customized version only> */
} BSSE_CTRL;
...
typedef struct 
{
	...
	void (*setSystemExclusiveMessage) (BSSE_HANDLE handle, unsigned char port, unsigned char status, unsigned char *data, int size);
