...
/* Copyright (c) 2002-2018 bismark LLC */
...
typedef enum
{
	...
	BSMP_CTRL_SET_CALLBACK_DELAY = 20000,  /* <customized version only> */
	BSMP_CTRL_GET_CALLBACK_DELAY,  /* <customized version only> */

	BSMP_CTRL_SET_PORT_SELECTION_METHOD = 20010,  /* <customized version only> */
	BSMP_CTRL_GET_PORT_SELECTION_METHOD,  /* <customized version only> */
	
	BSMP_CTRL_SET_WAVE = 21000,  /* <customized version only> */
...
typedef enum
{
	...
	BSMP_WAVE_FILE_AIFF,
	BSMP_WAVE_FILE_MP3, /* <customized version only> */
} BSMP_WAVE_FILE;
...
enum 
{
	...
	BSMP_PORT_SELECTION_METHOD_U,
	BSMP_PORT_SELECTION_METHOD_S,
	BSMP_PORT_SELECTION_METHOD_D,
	BSMP_PORT_SELECTION_METHOD_K,
	...
	/* kt volume <customized version only> */
	BSMP_KT_VOLUME_MIN = 0,
	BSMP_KT_VOLUME_DEF = 100,
	BSMP_KT_VOLUME_MAX = 100,
...
typedef enum {
	BSMP_WAVE_TRIGGER_MODE_TOP = 0,
} BSMP_WAVE_TRIGGER_MODE; /* <customized version only> */
...
typedef struct {
	...
	LPCTSTR path;
	BSMP_WAVE_FILE type;
	BSMP_WAVE_TRIGGER_MODE triggerMode;
	int allowKeyControl;
} BSMP_WAVE; /* <customized version only> */
