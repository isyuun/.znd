...
class KPLyricsX extends KPLyrics {
    ...
    private void outRect(Canvas canvas, Paint paint, int m, int w, int y, int colorTitle, int colorName) {
        ...
        //if (BuildConfig.DEBUG) Log.wtf(__CLASSNAME__, getMethodName() + mLyricsPlay.m_iSongInfoPosition + ":" + r1 + ":" + r2);
    ...
    void setSinger(Canvas canvas, Paint paint, String str1, String str2, String str3) {
        ...
        //if (BuildConfig.DEBUG) Log.wtf(__CLASSNAME__, getMethodName() + ":" + m_height + ":" + w + ":" + rect + "\n" + strSinger + "\n" + strComposer + "\n" + strLyricist);
    ...
    protected void runDraw() {
        //if (BuildConfig.DEBUG) Log.wtf(__CLASSNAME__, getMethodName() + ":" + done + ":" + !isAlive() + ":" + isInterrupted());
        while (!done) {
            try {
                ...
                Log.wtf(toString(), getMethodName() + "[NG]" + "\n" + Log.getStackTraceString(e));
                e.printStackTrace();
            }
            try {
    ...
    public void draw() {
        ...
        try {
            if (!mLyricsPlay.m_redraw) {
                //if (BuildConfig.DEBUG) Log.wtf(__CLASSNAME__, getMethodName() + mSurfaceHolder);
    ...
    public void show() {
        mLyricsPlay.m_redraw = false;
        draw();
        mLyricsPlay.m_redraw = true;
    }
}
