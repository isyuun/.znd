...
public class LyricsTime {
    ...
    public LyricsTime(String previousLine, String nextLine, String currentLine, String currentWord, long startMillis, long endMillis, long length, int lineNumber, int wordIndex, int type, ArrayList<String> words) {
