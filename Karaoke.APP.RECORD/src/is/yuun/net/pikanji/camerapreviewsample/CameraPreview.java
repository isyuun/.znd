...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
	...
	protected String LOG_TAG = __CLASSNAME__;
	...
	private void doSurfaceChanged(int width, int height) {
		Log.d(LOG_TAG, "doSurfaceChanged()" + mSurfaceConfiguring);
		...
		if (!mSurfaceConfiguring) {
			...
			if (mSurfaceConfiguring && (mSurfaceChangedCallDepth <= 1)) {
				Log.d(__CLASSNAME__, getMethodName() + "NG!!!!" + mSurfaceConfiguring);
				return;
			}
		}
		...
		Log.d(__CLASSNAME__, getMethodName() + "OK!!!");
	}
	...
	protected boolean adjustSurfaceLayoutSize(Camera.Size previewSize, boolean portrait,
		...
		Log.d(__CLASSNAME__, getMethodName() + layoutChanged);
	...
	/**
	 * @param x
	 *          X coordinate of center position on the screen. Set to negative value to unset.
	 * @param y
