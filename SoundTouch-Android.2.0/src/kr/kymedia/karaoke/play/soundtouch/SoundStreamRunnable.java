...
public abstract class SoundStreamRunnable implements Runnable, AudioFormatChangedListener
{
	...
	private volatile com.smp.soundtouchandroid.OnProgressChangedListener progressListener;
	...
	public void setOnProgressChangedListener(
			com.smp.soundtouchandroid.OnProgressChangedListener progressListener)
	{
	...
	Context context;
	public SoundStreamRunnable(Context context, int id, String fileName, float tempo,
	...
	private void initDecoder(String fileName) throws IOException
	{
		if (Build.VERSION.SDK_INT >= 16)
		{
			...
			if (fileName.contains("file:///android_asset/")) {
				...
				decoder = new kr.kymedia.karaoke.play.soundtouch.MediaCodecAudioDecoder(descriptor, this);
