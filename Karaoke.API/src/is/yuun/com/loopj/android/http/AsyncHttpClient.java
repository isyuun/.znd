 ...
 * and responses can be handled by passing an anonymously overridden {@link AsyncHttpResponseHandler} instance.
 * <p>
 * For example:
 * <p>
 * 
...
public class AsyncHttpClient {
	 ...
	 * passed Context.
	 * <p>
	 * <b>Note:</b> This will only affect requests which were created with a non-null android Context. This method is intended to be used in the onDestroy method of your android activities to destroy all requests which are no longer required.
	 *
	 * @param context
	 ...
	 *          the URL to send the request to.
	 * @param entity
	 *          a raw {@link HttpEntity} to send with the request, for example, use this to send string/json/xml payloads to a server by passing a {@link org.apache.http.entity.StringEntity}.
	 * @param contentType
