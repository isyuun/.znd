...
@SuppressLint("NewApi")
public class PlayView2 extends TextureView implements SongView, TextureView.SurfaceTextureListener, PlayViewListener {
	...
	public PlayView2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		m_context = context;
	}

	public PlayView2(Context context, SongPlay songPlay, int viewType) {
		super(context);
		m_context = context;
	...
	public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
		Log.d("PlayView2", "onSurfaceTextureAvailable");
		...
		if (m_screenThread != null)
			m_screenThread.onWindowResize(width, height);
	}
